...
shell. Dashboard endpoint paths are generated the same way as `uiEndpoints`.
The frontend reads both contracts from the generated shell instead of
maintaining separate hardcoded support or route lists.
